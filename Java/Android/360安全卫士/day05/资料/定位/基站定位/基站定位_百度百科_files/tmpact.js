...
//添加到[id='header']上面
(function(){
var show = 0; //是否展示，0是不展示，1是展示，2只在首页展示，3只在词条页展示
	...
	var linkSrc2 = 'http://baike.baidu.com/cms/s/food/200x100.gif ';//图片的地址 
	var linkHref2 = 'http://baike.baidu.com/view/1176.htm';//图片的链接
	var linkText2 = '今天，你被地沟油了吗？';//鼠标滑过信息
	var isLink2 = true;
	var isFlash2 = false;
